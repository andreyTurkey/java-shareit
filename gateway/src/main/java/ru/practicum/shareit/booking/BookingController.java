...
public class BookingController {
    ...
    public ResponseEntity<Object> addBooking(@Valid @RequestBody BookingAddDto body,
                                             @Positive @RequestHeader(value = USER_FROM_HEADER) Long bookerId) {
        return bookingClient.addBooking(bookerId, body);
    }

    @PatchMapping(value = "/{bookingId}")
    public ResponseEntity<Object> updateStatus(@RequestHeader(value = USER_FROM_HEADER) Long bookerId,
    ...
    @GetMapping
    public ResponseEntity<Object> getAllBookingsByBookerId(@RequestHeader(value = USER_FROM_HEADER) Long bookerId,
    ...
    public ResponseEntity<Object> getAllBookingsByOwnerId(@RequestHeader(value = USER_FROM_HEADER) Long ownerId,
                                                    @RequestParam(value = "from", required = false) @PositiveOrZero Integer from,
                                                    @RequestParam(value = "size", required = false) Integer size,
                                                    @RequestParam(value = "state",
                                                            defaultValue = "ALL") String state) {
